            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="breadcrumb__wrapper">
                        <h1 class="breadcrumb__title display-4 fw-semibold text-center"> Program Unggulan</h1>
                        <ul class="breadcrumb__list d-flex align-items-center justify-content-center gap-4">
                            ...
                            <li class="breadcrumb__item">
                                <span class="text-main-two-600"> Program Unggulan </span>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="course-item bg-main-25 rounded-16 p-12 h-100 border border-neutral-30">
                            <div class="course-item__thumb rounded-12 overflow-hidden position-relative">
                                <a href="course-details.html" class="w-100 h-100">
                                    <img src="{{ asset('storage' . '/' . $program->image) }}" alt="Course Image"
                                ...
                                <div class="">
                                    <h4 class="mb-28">
                                        <a href="course-details.html"
                                            class="link text-line-2">{{ $program->program_name }}</a>
                                    </h4>
                                    <div class="flex-between gap-8 flex-wrap mb-16">
                                        <div class="flex-align gap-8">

                                            <span
                                                class="text-neutral-500 text-line-2">{{ strip_tags($program->description) }}</span>
                                        </div>
